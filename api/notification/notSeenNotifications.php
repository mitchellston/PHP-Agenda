...
try {
    ...
    $result = $databaseConnection->select(["Seen"], "notifications", [["column" => "ToUser", "method" => CompareMethods::equals, "value" => ["value" => $_SESSION["User"], "type" => PropertyTypes::int]]], null, 1);
