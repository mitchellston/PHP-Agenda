...
try {
    ...
    $result = $databaseConnection->select(
        ...
        [["tableToJoin" => "users", "typeOfJoin" => \dbHandler\TypeOfJoin::LEFT , "fromColumn" => "notifications.FromUser", "toColumn" => "users.ID"],
            ["tableToJoin" => "items", "typeOfJoin" => \dbHandler\TypeOfJoin::LEFT , "fromColumn" => "notifications.Item", "toColumn" => "items.ID"]], null,
    ...
    $databaseConnection->update("notifications", [["column" => "Seen", "value" => ["value" => 1, "type" => PropertyTypes::int]]], [["column" => "ID", "method" => CompareMethods::equals, "value" => ["value" => $_SESSION["User"], "type" => PropertyTypes::int]],["column" => "Seen", "method" => CompareMethods::equals, "value" => ["value" => 0, "type" => PropertyTypes::int]]]);
